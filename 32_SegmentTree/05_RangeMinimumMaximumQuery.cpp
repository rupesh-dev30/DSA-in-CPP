/*
  Range Minimum/Maximum Query (Replace sum with min or max)

  Instead of storing sum in segment tree, store min or max.

 Use case:
  Find min/max element in range [L, R] in O(log n)

  Example: RMQ on heights, prices, temperatures
